...
import com.emerson.identity.identity_service.repositories.JpaAuthorizationConsentRepository;
...
//@Service
public class OAuth2AuthorizationConsentServiceImp implements OAuth2AuthorizationConsentService {

    private final JpaAuthorizationConsentRepository authorizationConsentRepository;
    private final RegisteredClientRepository registeredClientRepository;

    public OAuth2AuthorizationConsentServiceImp(JpaAuthorizationConsentRepository authorizationConsentRepository, RegisteredClientRepository registeredClientRepository) {
    ...
    private OAuth2AuthorizationConsent toObject(AuthorizationConsent authorizationConsent) {
        ...
        OAuth2AuthorizationConsent.Builder builder = OAuth2AuthorizationConsent.withId(
                registeredClientId, authorizationConsent.getAuthorizationConsentId().getPrincipalName());
    ...
    private AuthorizationConsent toEntity(OAuth2AuthorizationConsent authorizationConsent) {
        ...
        AuthorizationConsent.AuthorizationConsentId id = new AuthorizationConsent.AuthorizationConsentId();
        id.setRegisteredClientId(authorizationConsent.getRegisteredClientId());
        id.setPrincipalName(authorizationConsent.getPrincipalName());
        entity.setAuthorizationConsentId(id);
